...
# 🧮 Liquidador Reforma Laboral 2466

**Liquidación de nómina, recargos y prestaciones bajo la Ley 2466 de 2025**

Laboratorio 01 de la suite de cumplimiento operable de **NiAnd Labs S.A.S.**

[![CI](https://github.com/AndreZzRg/niand-liquidador-2466/actions/workflows/ci.yml/badge.svg)](https://github.com/AndreZzRg/niand-liquidador-2466/actions/workflows/ci.yml)
[![Pages](https://github.com/AndreZzRg/niand-liquidador-2466/actions/workflows/pages.yml/badge.svg)](https://github.com/AndreZzRg/niand-liquidador-2466/actions/workflows/pages.yml)
[![CodeQL](https://github.com/AndreZzRg/niand-liquidador-2466/actions/workflows/codeql.yml/badge.svg)](https://github.com/AndreZzRg/niand-liquidador-2466/actions/workflows/codeql.yml)
...
### [▶ Abrir la aplicación](https://andrezzrg.github.io/niand-liquidador-2466/)
...
Calculadora de nómina y liquidación definitiva de contrato que aplica el régimen de la Ley 2466 de 2025: jornada nocturna desde las 7:00 p. m., progresión del recargo dominical y festivo (80 % en 2025, 90 % en 2026, 100 % desde julio de 2027), horas extra, prestaciones sociales, aportes e indemnización por despido sin justa causa.


### Módulos

1. **Devengado y recargos**
2. **Liquidación definitiva**
3. **Seguridad social y parafiscales**
4. **Indemnización**
5. **Comparador 2025 / 2026 / 2027**
...
```bash
git clone https://github.com/AndreZzRg/niand-liquidador-2466.git
cd niand-liquidador-2466
npm install
npm run dev
```
...
```bash
# Con GitHub CLI
gh repo create AndreZzRg/niand-liquidador-2466 --public --source=. --remote=origin --push

# O de forma manual, si ya creó el repositorio vacío en github.com
git remote add origin https://github.com/AndreZzRg/niand-liquidador-2466.git
git branch -M main
...
```
https://andrezzrg.github.io/niand-liquidador-2466/
```
...
| **Ley 2466 de 2025** | Reforma laboral. Jornada nocturna desde las 7:00 p. m. y progresión del recargo dominical y festivo. |
| **Código Sustantivo del Trabajo** | Arts. 127, 128, 132, 160, 168, 179, 186, 249, 306 y 64. |
| **Ley 50 de 1990** | Régimen de cesantías e intereses a las cesantías. |
| **Ley 1393 de 2010** | Art. 30: límite del 40 % a los pagos no constitutivos de salario para efectos del IBC. |
