# Registro de decisiones de arquitectura — Liquidador Reforma Laboral 2466
...
**Contexto.** GitHub Pages sirve el proyecto bajo `/niand-liquidador-2466/`. Fijar esa ruta en la
