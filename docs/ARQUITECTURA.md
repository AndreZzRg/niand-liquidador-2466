# Arquitectura — Liquidador Reforma Laboral 2466
...
Una carpeta por módulo: `devengado-y-recargos`, `liquidacion-definitiva`, `seguridad-social-y-parafiscales`, `indemnizacion`, `comparador-2025-2026-2027`.
...
`localStorage` bajo claves con prefijo `niand-liquidador-2466:`.
