...
export const MODULOS = [
  { id: 'devengado-y-recargos', rotulo: 'Devengado y recargos' },
  { id: 'liquidacion-definitiva', rotulo: 'Liquidación definitiva' },
  { id: 'seguridad-social-y-parafiscales', rotulo: 'Seguridad social y parafiscales' },
  { id: 'indemnizacion', rotulo: 'Indemnización' },
  { id: 'comparador-2025-2026-2027', rotulo: 'Comparador 2025 / 2026 / 2027' },
] as const;
    ...
    <div className="flex min-h-dvh flex-col">
      ...
      <header className="no-imprimir sticky top-0 z-30 border-b border-borde bg-superficie/92 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-x-4 gap-y-2 px-4 py-3 sm:px-6">
          <a
            href="https://github.com/AndreZzRg/niand-liquidador-2466"
            className="shrink-0"
            aria-label="Repositorio de Liquidador Reforma Laboral 2466"
          >
            <Logo alto={28} />
          </a>
          ...
          <div className="min-w-0 flex-1">
            <p className="truncate font-display text-sm font-semibold">
              <span aria-hidden>🧮 </span>Liquidador Reforma Laboral 2466
            </p>
